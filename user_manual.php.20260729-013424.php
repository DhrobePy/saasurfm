...
[
  ...
  'steps' => [
    'Open <strong>POS → POS Terminal</strong>. Add products to the cart by tapping them — stock and price come live from the same catalog and branch inventory the rest of the system uses.',
  ...
  'qa' => [
    ...
    ['q' => 'What happens if I try to sell more than what\'s in stock?', 'a' => 'The sale is blocked — POS does not have Trading\'s "sell anyway" override, since counter stock is expected to be accurate in real time.'],
    ['q' => 'I rang up the wrong item or quantity — can it be fixed without deleting the whole sale?', 'a' => 'Yes — an admin can open <strong>Edit</strong> on the sale from Today\'s Sales, correct the quantity, price, or payment split, and give a reason. This reverses the old inventory/ledger/accounting effect and posts a corrected one, same Recycle-Bin-backed reversal pattern as everywhere else. Admin edits apply immediately (admin submission is the approval, same as everywhere in this system).'],
    ['q' => 'Can I delete a POS sale entirely?', 'a' => 'Yes, admin-only, from Today\'s Sales — it reverses the inventory and any credit-ledger effect and moves it to the Recycle Bin, fully restorable if needed.'],
