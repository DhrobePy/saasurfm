...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $vehicle_label = $vehicle?->vehicle_number ?? 'Unknown Vehicle';
        $customer_label = $customer?->name ?? 'Unknown Customer';
        ...
        if (!$edit_mode) {
            ...
            $journal_desc = "Vehicle Rental for " . $customer_label .
            ...
            $db->insert('transaction_lines', [
                ...
                'entry_type' => 'debit',
                'amount' => $total_amount,
                'description' => "Invoice for " . $vehicle_label . " rental"
            ]);
            ...
            $db->insert('transaction_lines', [
                ...
                'entry_type' => 'credit',
                'amount' => $total_amount,
                'description' => "Rental income from " . $customer_label
            ]);
