                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <?php else: ?>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <div class="text-sm text-gray-900"><?php echo $rental->start_datetime ? date('d M Y, h:i A', strtotime($rental->start_datetime)) : '—'; ?></div>
                                <div class="text-xs text-gray-500">to <?php echo $rental->end_datetime ? date('d M Y, h:i A', strtotime($rental->end_datetime)) : '—'; ?></div>
                            </td>
                            ...
                            <td class="px-4 py-3 text-sm text-right font-bold text-gray-900">
                                ৳<?php echo number_format($rental->total_amount ?? 0, 2); ?>
                            </td>
