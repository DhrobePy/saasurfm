    ...
    try {
        ...
        if ($action === 'accept') {
            ...
            foreach ($orders as $order) {
                ...
                // Accounting — posted via the shared helper, same reasoning as the
                // identical fix in trips/schedule.php (this file's comment even said
                // "same as in create.php", confirming it was a hand-copied duplicate):
                // wrong-revenue-account risk, missing Other-Sales COGS, no idempotency
                // guard, and a customers.current_balance double-debit (current_balance
                // is already incremented once at order creation).
