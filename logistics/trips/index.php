...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($action === 'add_order_to_trip') {
            ...
            // Post the same dispatch accounting cr/credit_dispatch.php posts (journal
            // + customer_ledger + invoice_snapshot) — this action moves the order to
            // 'shipped' just like the main dispatch board does, but was never posting
            // any accounting at all. Idempotent — no-ops if already posted.
