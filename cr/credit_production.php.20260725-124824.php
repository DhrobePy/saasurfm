    ...
    try {
        ...
        if ($action === 'start' && $can_update_status) {
            ...
            if ($sched) {
                ...
                $db->insert('production_schedule', ['order_id' => $order_id, 'production_started_at' => date('Y-m-d H:i:s'), 'status' => 'in_progress']);
            }
            ...
            if ($sched) {
                ...
                $db->insert('production_schedule', ['order_id' => $order_id, 'priority_order' => $priority]);
            }
