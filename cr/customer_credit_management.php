...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_credit') {
    try {
        ...
        $payment_terms = (int)$_POST['payment_terms_days'];
    ...
    [$credit_limit, $customer_id]
        ...
        $_SESSION['success_flash'] = "Credit limit updated successfully";
...
<div class="mb-6">
    ...
    <p class="text-lg text-gray-600 mt-1">Manage customer credit limits and payment terms</p>
</div>
        ...
        <form method="POST" class="p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number" name="payment_terms_days" id="edit_payment_terms" required 
                ...
                <div>
                    ...
                    <textarea name="notes" id="edit_notes" rows="3" 
                              ...
                              placeholder="Any notes about this customer's credit..."></textarea>
                </div>
...
function editCredit(customerId) {
    ...
    document.getElementById('edit_payment_terms').value = customer.payment_terms_days || 30;
    document.getElementById('edit_credit_status').value = customer.credit_status || 'active';
    document.getElementById('edit_notes').value = customer.credit_notes || '';
    
    document.getElementById('current_limit').textContent = '৳' + (customer.credit_limit || 0).toFixed(0);
    document.getElementById('current_used').textContent = '৳' + (customer.used_credit || 0).toFixed(0);
    document.getElementById('current_available').textContent = '৳' + (customer.available_credit || 0).toFixed(0);
