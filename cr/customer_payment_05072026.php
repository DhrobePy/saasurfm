    ...
    try {
        ...
        if (!$is_admin) {
            ...
            if ($collect_cap !== null && $payment_amount > $collect_cap) {
                throw new Exception('This receipt (৳' . number_format($payment_amount, 0)
                    . ') exceeds your collection limit of ৳' . number_format($collect_cap, 0)
                    . '. A senior officer must record payments above your limit.');
            }
        }
