      ...
      <table class="min-w-full text-sm">
        <thead class="bg-gray-50 border-b border-gray-200">
          <tr>
            ...
            <?php if (in_array($currentUser['role'] ?? '', ['Superadmin', 'admin'])): ?>
            <th class="px-3 py-3 text-center text-xs font-semibold text-red-400 uppercase whitespace-nowrap">Delete</th>
            <?php endif; ?>
          </tr>
        </thead>
