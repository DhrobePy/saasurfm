...
// Feature #1: a posted payment may be reversed/edited by Superadmin OR Admin.
// Every reversal is archived to the Recycle Bin (restorable). Accounts users and
// collectors still cannot reverse posted receipts.
