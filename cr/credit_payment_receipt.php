...
<body>
    <button onclick="window.print()" class="print-button no-print" title="Print or Save as PDF">
        🖨️ Print / Save PDF
    </button>
    ...
    <div class="receipt-container">
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            <p style="font-size: 16px;"><strong>Receipt No:</strong> <?php echo htmlspecialchars($payment->payment_number); ?></p>
