...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'collect_payment') {
    ...
    if ($customer_id <= 0) {
    ...
    } elseif (!$is_admin && (paymentApprovalRequiredForAll() || ($collect_cap !== null && $payment_amount > $collect_cap))) {
        ...
        // receipt queues; otherwise only those over the user's collect_payment limit.
