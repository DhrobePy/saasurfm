...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'collect_payment') {
    ...
    if ($customer_id <= 0) {
        ...
        $error = "This receipt (৳" . number_format($payment_amount, 0) . ") exceeds your collection limit of ৳"
               . number_format($collect_cap, 0) . ". A senior officer must record payments above your limit.";
