...
// Can bypass the 80% credit escalation threshold (Superadmin/admin always true)
$is_admin = userCanPageAction('credit_sales', 'credit_order_approval', 'can_escalate_override');
