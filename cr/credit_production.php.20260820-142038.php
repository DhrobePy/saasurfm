...
// Same active-pipeline statuses as the production queue above — once an order
// is shipped/delivered it's no longer a pending "delivery due" concern here.
$due_today_orders = [];
$overdue_orders   = [];
try {
...
$render_delivery_table = function ($rows, $show_days_overdue) use ($status_cls, $status_labels, $delivery_vehicle_badge) {
    if (empty($rows)) {
