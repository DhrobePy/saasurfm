                                    ...
                                    <tr class="border-b border-gray-100">
                                        ...
                                        <td class="px-3 py-2">
                                            <span class="inline-block px-1.5 py-0.5 rounded text-[10px] font-semibold capitalize"
                                                  :class="['shipped','delivered'].includes(order.status) ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'"
                                                  x-text="(order.status || '').replace(/_/g, ' ')"></span>
                                            <div class="text-[9px] text-amber-600 mt-0.5"
                                                 x-show="order.status && !['shipped','delivered'].includes(order.status)">
