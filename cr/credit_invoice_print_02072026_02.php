...
.co-name{font-size:24px;font-weight:800;color:var(--grn);line-height:1.1;}
.co-en  {font-size:10px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:1.2px;margin-top:2px;}
.co-meta{font-size:10px;color:var(--muted);margin-top:4px;line-height:1.6;text-align:center;}
...
.inv-word{
  ...
  padding:5px 16px;margin-bottom:5px;
}
.inv-num {font-size:12px;font-weight:700;color:var(--ink);}
.inv-date{font-size:10.5px;color:var(--muted);margin-top:2px;}
.s-pill{
...
.info-col{padding:9px 16px;border-right:1px solid var(--line);}
...
.info-col .nm{font-size:12px;font-weight:700;color:var(--ink);margin-bottom:2px;}
.info-col p  {font-size:10.5px;color:var(--ink2);margin:2px 0;}
.info-col .kv{display:flex;font-size:10.5px;margin:2.5px 0;}
.info-col .kv .k{color:var(--muted);min-width:72px;flex-shrink:0;}
...
.itbl th{padding:6px 8px;font-size:9px;font-weight:700;letter-spacing:.4px;text-transform:uppercase;color:#fff;}
...
.itbl td{padding:6px 8px;font-size:11px;color:var(--ink2);vertical-align:middle;}
.p-name{font-weight:700;color:var(--ink);font-size:11px;line-height:1.2;}
...
.itbl tfoot td{padding:5px 8px;font-size:10px;font-weight:700;color:var(--muted);background:var(--surf);border-top:2px solid var(--grn);}

/* Bottom row */
.bot-row{display:flex;border-top:1px solid var(--line);}
.bot-left {flex:1;padding:10px 16px;border-right:1px solid var(--line);}
.bot-right{width:220px;flex-shrink:0;}
.ship-ttl{font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.6px;color:var(--grn);margin-bottom:5px;padding-bottom:3px;border-bottom:2px solid var(--grn-lt);}
.kv2{display:flex;font-size:10.5px;margin:2.5px 0;}
.kv2 .k{color:var(--muted);min-width:78px;flex-shrink:0;}
.kv2 .v{color:var(--ink);font-weight:600;}
.prev-due-box{display:flex;justify-content:space-between;align-items:center;padding:5px 10px;background:var(--grn-bg);border-bottom:1px solid var(--grn-lt);}
.prev-due-box .pl{font-size:9px;font-weight:700;color:var(--grn-dk);}
.prev-due-box .pv{font-size:12px;font-weight:800;color:var(--grn-dk);}
.tots-inner{padding:7px 10px;}
.tr2{display:flex;justify-content:space-between;padding:3px 0;font-size:10.5px;border-bottom:1px dashed var(--line);}
.tr2:last-child{border:none;}
.tr2 .tl{color:var(--muted);}
.tr2 .tv{font-weight:600;color:var(--ink);}
.grand-row{display:flex;justify-content:space-between;align-items:center;padding:8px 10px;background:var(--grn);}
.grand-row .gl{font-size:12px;font-weight:800;color:#fff;}
.grand-row .gv{font-size:16px;font-weight:900;color:#fff;}
.outstanding-row{display:flex;justify-content:space-between;align-items:center;padding:5px 10px;background:var(--grn-dk);}
.outstanding-row .ol{font-size:10px;font-weight:700;color:#fff;}
.outstanding-row .ov{font-size:13px;font-weight:900;color:#fff;}

/* Invoice signature row */
.sig-row{display:flex;gap:12px;padding:10px 16px 12px;border-top:1px solid var(--line);}
.sig-box{flex:1;}
.sig-line{border-top:2px solid #333;margin-top:26px;padding-top:4px;}
.sig-lbl {font-size:8.5px;font-weight:800;text-transform:uppercase;letter-spacing:.5px;color:var(--muted);}
.sig-name{font-size:10px;color:var(--ink2);margin-top:2px;}
...
.strip-head.dr-head{background:var(--grn);}
.strip-head.gp-head{background:var(--grn-dk);}

.sh-left .sh-title{font-size:14px;font-weight:900;color:#fff;letter-spacing:3px;text-transform:uppercase;line-height:1;}
.sh-left .sh-sub  {font-size:8.5px;color:rgba(255,255,255,.75);text-transform:uppercase;letter-spacing:.8px;margin-top:2px;}
.sh-right .sh-inv {font-size:11.5px;font-weight:800;color:#fff;text-align:right;}
.sh-right .sh-date{font-size:8.5px;color:rgba(255,255,255,.7);text-align:right;margin-top:1px;}
...
.si-lbl{font-size:8px;font-weight:800;text-transform:uppercase;letter-spacing:.4px;color:var(--muted);margin-bottom:1px;}
.si-val{font-weight:700;color:var(--ink);font-size:10.5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}

/* Qty-only table */
.q-tbl{width:100%;border-collapse:collapse;}
.q-tbl thead tr{background:var(--grn-dk);}
.gp-head-tbl .q-tbl thead tr{background:#374151;}
.q-tbl th{padding:4px 8px;font-size:8px;font-weight:700;letter-spacing:.4px;text-transform:uppercase;color:#fff;}
.q-tbl th.r,.q-tbl td.r{text-align:right;}
.q-tbl th.c,.q-tbl td.c{text-align:center;}
.q-tbl tbody tr{border-bottom:1px solid var(--line);}
.q-tbl tbody tr:nth-child(even){background:var(--surf);}
.q-tbl td{padding:4px 8px;font-size:10.5px;color:var(--ink2);}
.q-tbl tfoot tr{background:var(--grn);}
.gp-head-tbl .q-tbl tfoot tr{background:#374151;}
.q-tbl tfoot td{padding:5px 8px;font-size:11px;font-weight:800;color:#fff;}

/* Signature rows */
.strip-sig{display:flex;gap:10px;padding:8px 16px 10px;border-top:1px solid var(--line);}
.ss-box{flex:1;}
.ss-line{border-top:2px solid #333;margin-top:22px;padding-top:4px;}
.ss-lbl{font-size:8px;font-weight:800;text-transform:uppercase;letter-spacing:.4px;color:var(--ink);}
.ss-sub{font-size:9px;color:var(--muted);margin-top:2px;}

.gp-footer{
  background:var(--surf);border-top:1px solid var(--line);
  padding:4px 16px;font-size:8.5px;color:var(--muted);text-align:center;
}
...
@media print{
  ...
  /* Invoice header */
  .inv-header{padding:9px 14px 7px !important;gap:10px !important;}
  .co-logo img{max-height:64px !important;max-width:64px !important;}
  .co-name{font-size:18px !important;}
  .co-en  {font-size:8.5px !important;}
  .co-meta{font-size:8.5px !important;margin-top:2px !important;}
  .inv-word{font-size:15px !important;letter-spacing:4px !important;padding:3px 11px !important;margin-bottom:4px !important;}
  .inv-num {font-size:10px !important;}
  .inv-date{font-size:9px !important;}
  .s-pill  {font-size:7.5px !important;margin-top:3px !important;}

  /* Info row */
  .info-col{padding:7px 11px !important;}
  .info-col h4{font-size:7.5px !important;margin-bottom:4px !important;padding-bottom:2px !important;}
  .info-col .nm{font-size:10px !important;margin-bottom:1px !important;}
  .info-col p  {font-size:9px !important;margin:1.5px 0 !important;}
  .info-col .kv{font-size:9px !important;margin:1.5px 0 !important;}
  .info-col .kv .k{min-width:60px !important;}

  /* Items */
  .sec-lbl{padding:4px 11px 2px !important;font-size:7.5px !important;}
  .itbl th {padding:4px 6px !important;font-size:7.5px !important;}
  .itbl td {padding:4px 6px !important;font-size:9.5px !important;}
  .p-name  {font-size:9.5px !important;}
  .p-sub   {font-size:7.5px !important;}
  .itbl tfoot td{padding:3px 6px !important;font-size:8.5px !important;}

  /* Bottom */
  .bot-left {padding:7px 11px !important;}
  .bot-right{width:195px !important;}
  .ship-ttl {font-size:7.5px !important;margin-bottom:4px !important;padding-bottom:2px !important;}
  .kv2      {font-size:9.5px !important;margin:2px 0 !important;}
  .kv2 .k   {min-width:68px !important;}
  .prev-due-box{padding:4px 8px !important;}
  .prev-due-box .pl{font-size:8px !important;}
  .prev-due-box .pv{font-size:10.5px !important;}
  .tots-inner{padding:5px 8px !important;}
  .tr2      {font-size:9.5px !important;padding:2px 0 !important;}
  .grand-row{padding:6px 8px !important;}
  .grand-row .gl{font-size:10px !important;}
  .grand-row .gv{font-size:13px !important;}
  .outstanding-row{padding:4px 8px !important;}
  .outstanding-row .ol{font-size:8.5px !important;}
  .outstanding-row .ov{font-size:11px !important;}

  /* Invoice sigs */
  .sig-row {padding:7px 11px 9px !important;gap:10px !important;}
  .sig-line{margin-top:20px !important;}
  .sig-lbl {font-size:7.5px !important;}
  .sig-name{font-size:9px !important;}

  /* Cut lines */
  .cut-line{padding:3px 11px !important;font-size:7.5px !important;}

  /* Strips */
  .strip-head{padding:6px 11px !important;}
  .sh-left .sh-title{font-size:11px !important;letter-spacing:2.5px !important;}
  .sh-left .sh-sub  {font-size:7px !important;}
  .sh-right .sh-inv {font-size:10px !important;}
  .sh-right .sh-date{font-size:7.5px !important;}
  .si-cell{padding:4px 9px !important;}
  .si-lbl {font-size:7px !important;}
  .si-val {font-size:9.5px !important;}

  .q-tbl th{padding:3px 6px !important;font-size:7px !important;}
  .q-tbl td{padding:3px 6px !important;font-size:9.5px !important;}
  .q-tbl tfoot td{padding:4px 6px !important;font-size:10px !important;}

  .strip-sig{padding:6px 11px 8px !important;gap:8px !important;}
  .ss-line  {margin-top:18px !important;}
  .ss-lbl   {font-size:7px !important;}
  .ss-sub   {font-size:7.5px !important;}
  .gp-footer{padding:3px 11px !important;font-size:7.5px !important;}
}
</style>
</head>
<body>
...
══════════════════════════════════════════════════════════ -->
  ...
  <div class="info-row">
    ...
    <div class="info-col">
      <h4>Deliver To</h4>
      <?php if ($deliver_to): ?>
        <div class="nm" style="font-size:11px"><?php echo nl2br(htmlspecialchars($deliver_to)); ?></div>
      <?php else: ?>
        <p style="color:var(--muted);font-style:italic">Same as billing address</p>
      <?php endif; ?>
      <?php if ($order->branch_name): ?>
        <p style="margin-top:4px">
          <span style="display:inline-block;background:var(--grn-lt);color:var(--grn-dk);font-size:9px;font-weight:700;padding:2px 8px;border-radius:10px;border:1px solid var(--grn)">
  ...
  <div class="bot-row">
    <div class="bot-left">
      ...
      <?php else: ?>
        <p style="font-size:9px;color:var(--muted);font-style:italic">No shipping details recorded.</p>
      <?php endif; ?>
      <?php if (!empty($order->special_instructions)): ?>
        <div style="margin-top:7px">
          <div class="ship-ttl">Notes</div>
          <p style="font-size:10px;color:var(--ink2)"><?php echo nl2br(htmlspecialchars($order->special_instructions)); ?></p>
        </div>
      <?php endif; ?>
    ...
    <div class="bot-right">
      ...
      <div class="tr2" style="padding:5px 12px;border-bottom:1px dashed var(--line);">
...
══════════════════════════════════════════════════════════ -->
  ...
  <table class="q-tbl">
    ...
    <tfoot>
      <tr>
        <td colspan="3" style="text-align:right;font-size:8px;color:rgba(255,255,255,.8);letter-spacing:.5px">TOTAL QTY</td>
