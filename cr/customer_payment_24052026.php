...
$customers = $db->query(
    "SELECT id, name, business_name, phone_number, credit_limit, initial_due,
            current_balance as outstanding_balance,
...
<div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg text-blue-800 text-sm flex items-center gap-3">
    <i class="fas fa-link text-blue-500"></i>
    <span>
        Pre-loading from order <strong><?php echo htmlspecialchars($preload_order->order_number); ?></strong>
    ...
    <a href="customer_payment.php" class="ml-auto text-blue-500 hover:text-blue-700 text-xs"><i class="fas fa-times mr-1"></i>Clear</a>
</div>
<?php endif; ?>
...
<div x-data="paymentForm()" @customer-selected.window="selectCustomer($event.detail)" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <!-- Hidden field for Alpine/form submission -->
            ...
            <p id="cp_selected_label" class="mt-1 text-xs text-green-700 font-medium hidden"></p>
            ...
            <fieldset :disabled="!customer.id">
                <div class="p-6">
                    ...
                    <div id="bankAccountDiv" style="display:none;" class="mt-4">
                        ...
                        <p id="bank_selected_label" class="mt-1 text-xs text-green-700 font-medium hidden"></p>
                    </div>
    ...
    <div class="space-y-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="space-y-2">
                ...
                <a href="index.php" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-right font-bold text-green-600">৳<?php echo number_format($payment->amount, 2); ?></td>
