...
try {
    ...
    switch ($action) {
        ...
        case 'get_products':
            ...
            // no branch_id filtering needed here either, but kept as a
            // required param since the caller (index.php) still passes it
            // and other parts of the page are branch-scoped.
