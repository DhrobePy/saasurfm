...
$pending_credit_approvals = $db->query(
    "SELECT COUNT(*) AS c, COALESCE(SUM(amount),0) AS amt FROM cr_pending_requests WHERE request_type IN ('pos_credit_sale', 'pos_exit_release') AND status = 'pending'"
)->first();
...
<div class="max-w-6xl mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
        ...
        <a href="pending_approvals.php" class="bg-white rounded-xl shadow-sm p-4 hover:shadow-md transition-shadow md:col-span-3">
            <div class="text-xs text-gray-500 uppercase">Pending Approvals (Credit-Limit + Exit Release)</div>
