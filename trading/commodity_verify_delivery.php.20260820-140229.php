...
<div class="bg-white rounded-2xl shadow-lg overflow-hidden">
    ...
    <div class="px-6 py-4 border-t border-gray-100 space-y-2 text-sm">
        <div class="flex justify-between"><span class="text-gray-500">Sale No.</span><span class="font-mono font-bold"><?php echo htmlspecialchars($sale->sale_number); ?></span></div>
