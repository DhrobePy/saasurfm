...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        if ($editMode && !empty($_POST['edit_id'])) {
            $bankManager->updateTransaction((int)$_POST['edit_id'], $_POST, $userId, $userName, $ipAddress, $userRole);
            $_SESSION['success_flash'] = $userRole === 'Superadmin'
                ? 'Transaction updated and auto-approved.'
