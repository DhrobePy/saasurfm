...
$isFullAdmin   = in_array($user_role, ['Superadmin', 'admin'], true);
...
// Data availability ($showBalance) is separate from who's allowed to SEE it —
// non-admin users (Accounts roles) get totals only, never any balance figure.
$canSeeBalance = $showBalance && $isFullAdmin;
...
<div class="w-full px-4 sm:px-6 lg:px-8 py-5">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-5">
        ...
        <?php if (($accountId || $btxAccountId) && $isFullAdmin): ?>
        <!-- Opening Balance -->
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-5">
        ...
        <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gray-50">
            ...
            <?php if ($isFullAdmin && !$showBalance && $source !== 'all'): ?>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <?php if ($accountId && $canSeeBalance && $page === 1): ?>
                    ...
                    <?php if (empty($txRows)): ?>
                    <tr>
                        <td colspan="<?= 7 + ($canSeeBalance ? 1 : 0) + ($is_superadmin ? 1 : 0) ?>"
