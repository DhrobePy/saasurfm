    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-4 mb-6 rounded-r-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
            ...
            <div>
                ...
                <p class="font-semibold text-gray-900">৳<?php echo rtrim(rtrim(number_format((float)$po->unit_price_per_kg, 10), '0'), '.'); ?>/KG</p>
            </div>
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="wheat_origin" id="wheat_origin" required
                            ...
                            <option value="Brazil" <?php echo $po->wheat_origin === 'Brazil-7up' ? 'selected' : ''; ?>>Brazil</option>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            <i class="fas fa-info-circle"></i> Original: <strong>৳<?php echo rtrim(rtrim(number_format((float)$po->unit_price_per_kg, 10), '0'), '.'); ?>/KG</strong>
                        </p>
                    </div>
