...
// Calculate balances based on EXPECTED payable + posted adjustments
$adj_amount     = floatval($po->total_adjustment_amount ?? 0);
$balance_before = $expected_payable + $adj_amount - ($po->total_paid - $payment->amount_paid);
$balance_after  = $expected_payable + $adj_amount - $po->total_paid;
