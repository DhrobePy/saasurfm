...
// is_admin_logged_in() is just an alias for isLoggedIn() (any authenticated
// user, no role check) — this page shows employee PII/HR data and was
// reachable by any logged-in staff regardless of role. Matches employees.php's
// own gate (the page that links here) so viewing a profile requires the same
// access as viewing the list.
$allowed_roles = [
