<?php
// new_ufmhrm/admin/edit_employee.php
...
// Same gap/fix as employee_profile.php — is_admin_logged_in() only checks
// "any user logged in," not role, and this page can WRITE to employee records.
$allowed_roles = [
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($db->query($updateSql, $params)) {
            // Update or insert salary structure
            if (isset($_POST['update_salary']) && $_POST['update_salary'] === '1') {
                ...
                $salaryParams = [
                    $employeeId, $basicSalary, $houseAllowance, $transportAllowance,
            ...
            $_SESSION['success_message'] = 'Employee profile updated successfully!';
            header('Location: employee_profile.php?id=' . $employeeId);
            exit();
        } else {
            $errors[] = 'Failed to update employee profile';
        }
    }
}
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8">
    <div class="max-w-6xl mx-auto px-4">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="employee_profile.php?id=<?php echo $employeeId; ?>" 
        ...
        <div class="bg-green-50 border-l-4 border-green-500 p-4 mb-6 rounded-lg">
            <div class="flex items-center">
                ...
                <p class="text-green-800 font-semibold"><?php echo $_SESSION['success_message']; unset($_SESSION['success_message']); ?></p>
            </div>
        </div>
        <?php endif; ?>
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-end -mt-16 gap-6">
                            ...
                            <div class="w-32 h-32 rounded-full border-4 border-white shadow-lg overflow-hidden bg-gradient-to-br from-indigo-100 to-purple-100">
                                <?php if ($employee->profile_picture && file_exists('../' . $employee->profile_picture)): ?>
                                    <img id="profilePreview" 
                                         src="../<?php echo htmlspecialchars($employee->profile_picture); ?>" 
                                         alt="Profile" 
                        ...
                        <div class="flex-1 text-center md:text-left">
                            ...
                            <p class="text-lg text-gray-600 mt-1">
                                Update information for <?php echo htmlspecialchars($employee->first_name . ' ' . $employee->last_name); ?>
                            </p>
                            <div class="mt-2">
                ...
                <div class="p-8">
                    ...
                    <div id="content-personal" class="tab-content active">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-600">Update employee's basic personal details</p>
                        </div>
                    ...
                    <div id="content-employment" class="tab-content">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-600">Manage employee's position, department, and work details</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" 
                                           name="base_salary" 
                                           value="<?php echo $employee->base_salary; ?>"
                                           step="0.01"
                                           class="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all outline-none"
                                           placeholder="0.00">
                                </div>
                        ...
                        <!-- Employment Info Cards -->
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-blue-600 mb-1">Current Department</p>
                                        <p class="text-lg font-bold text-blue-900"><?php echo htmlspecialchars($employee->department_name ?? 'N/A'); ?></p>
                                    </div>
                            ...
                            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-green-600 mb-1">Current Position</p>
                                        <p class="text-lg font-bold text-green-900"><?php echo htmlspecialchars($employee->position_name ?? 'N/A'); ?></p>
                                    </div>
                            ...
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-purple-600 mb-1">Tenure</p>
                                        <p class="text-lg font-bold text-purple-900">
                                            <?php 
                                            $hireDate = new DateTime($employee->hire_date);
                                            $today = new DateTime();
                                            $tenure = $hireDate->diff($today);
                                            echo $tenure->y . 'y ' . $tenure->m . 'm';
                                            ?>
                                        </p>
                                    </div>
                    ...
                    <div id="content-salary" class="tab-content">
                        <div class="mb-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-gray-600">Configure detailed salary breakdown and deductions</p>
                                </div>
                                <label class="flex items-center space-x-3 cursor-pointer bg-indigo-50 px-4 py-2 rounded-xl border-2 border-indigo-200 hover:bg-indigo-100 transition-all">
                                    <input type="checkbox" 
                                           name="update_salary" 
                                           value="1" 
                                           id="updateSalaryCheckbox"
                                           class="w-5 h-5 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                    <span class="text-sm font-semibold text-indigo-700">Update Salary Structure</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-blue-800 font-semibold">Current Salary Structure</p>
                                    <p class="text-blue-700 text-sm mt-1">
                                        Last updated: <?php echo date('M d, Y', strtotime($salaryStructure->created_date)); ?>
                                        • Net Salary: ৳<?php echo number_format($salaryStructure->net_salary, 2); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               name="basic_salary" 
                                               id="basicSalary"
                                               value="<?php echo $salaryStructure->basic_salary ?? 0; ?>"
                                               step="0.01"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="houseAllowance"
                                               value="<?php echo $salaryStructure->house_allowance ?? 0; ?>"
                                               step="0.01"
                                               oninput="calculateSalary()"
                                               class="salary-input w-full pl-12 pr-4 py-3 rounded-xl border-2 border-green-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all outline-none bg-white"
                                               placeholder="0.00">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="<?php echo $salaryStructure->transport_allowance ?? 0; ?>"
                                               step="0.01"
                                               oninput="calculateSalary()"
                                               class="salary-input w-full pl-12 pr-4 py-3 rounded-xl border-2 border-green-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all outline-none bg-white"
                                               placeholder="0.00">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="medicalAllowance"
                                               value="<?php echo $salaryStructure->medical_allowance ?? 0; ?>"
                                               step="0.01"
                                               oninput="calculateSalary()"
                                               class="salary-input w-full pl-12 pr-4 py-3 rounded-xl border-2 border-green-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all outline-none bg-white"
                                               placeholder="0.00">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="otherAllowances"
                                               value="<?php echo $salaryStructure->other_allowances ?? 0; ?>"
                                               step="0.01"
                                               oninput="calculateSalary()"
                                               class="salary-input w-full pl-12 pr-4 py-3 rounded-xl border-2 border-green-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all outline-none bg-white"
                                               placeholder="0.00">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               name="provident_fund" 
                                               id="providentFund"
                                               value="<?php echo $salaryStructure->provident_fund ?? 0; ?>"
                                               step="0.01"
                                               oninput="calculateSalary()"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               name="tax_deduction" 
                                               id="taxDeduction"
                                               value="<?php echo $salaryStructure->tax_deduction ?? 0; ?>"
                                               step="0.01"
                                               oninput="calculateSalary()"
                                               class="salary-input w-full pl-12 pr-4 py-3 rounded-xl border-2 border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all outline-none bg-white"
                                               placeholder="0.00">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="otherDeductions"
                                               value="<?php echo $salaryStructure->other_deductions ?? 0; ?>"
                                               step="0.01"
                                               oninput="calculateSalary()"
                                               class="salary-input w-full pl-12 pr-4 py-3 rounded-xl border-2 border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all outline-none bg-white"
                                               placeholder="0.00">
...
document.getElementById('editEmployeeForm').addEventListener('submit', function(e) {
    const updateSalary = document.getElementById('updateSalaryCheckbox').checked;
