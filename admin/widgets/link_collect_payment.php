<?php
// Widget: link_collect_payment — Quick link to customer payment collection
?>
<a href="../cr/advance_payment_collection.php"
   class="flex items-center gap-4 bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md hover:border-<?php echo $widget_color; ?>-300 transition group">
    ...
    <div>
        ...
        <p class="text-xs text-gray-500 mt-0.5">Record a customer payment</p>
    </div>
